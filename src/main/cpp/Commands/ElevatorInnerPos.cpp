...
/**
 * @brief Construct a new Elevator Inner Pos:: Elevator Inner Pos object
 * 
 ...
 * @param instant 
 */
ElevatorInnerPos::ElevatorInnerPos(double position, bool instant): frc::Command() {
    m_position = position;
    m_instant = instant;
 ...
 * 
 * Constantly sets the inner elevator position to m_position.
 */
 ...
 */
void ElevatorInnerPos::Interrupted() {
