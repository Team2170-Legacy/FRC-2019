    ...
    kP_Vision(frc::Preferences::GetInstance()->GetDouble("kP Vision", 30.0))
{
    ...
    pidControllerL->SetSmartMotionMaxVelocity(18.0);
    pidControllerR->SetSmartMotionMaxVelocity(18.0);
    pidControllerL->SetSmartMotionMaxAccel(30.0);
    pidControllerR->SetSmartMotionMaxAccel(30.0);
