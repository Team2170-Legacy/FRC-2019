...
Elevator::Elevator() : frc::Subsystem("Elevator"),
    ...
    kMaxInnerPos(frc::Preferences::GetInstance()->GetDouble("Max Inner", 32.5)),
    ...
    kHatchL1(frc::Preferences::GetInstance()->GetDouble("Hatch L1", 8.0)),
    kHatchL2(frc::Preferences::GetInstance()->GetDouble("Hatch L2", 38.0)),
    kHatchL3(frc::Preferences::GetInstance()->GetDouble("Hatch L3", 32.0)),
    kCargoL1(frc::Preferences::GetInstance()->GetDouble("Cargo L1", 20.0)),
    kCargoL2(frc::Preferences::GetInstance()->GetDouble("Cargo L2", 8.0)),
    kCargoL3(frc::Preferences::GetInstance()->GetDouble("Cargo L3", 32.0)),
